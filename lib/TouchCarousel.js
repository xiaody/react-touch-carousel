...
var TouchCarousel = function (_React$PureComponent) {
  ...
  function TouchCarousel(props) {
    ...
    _this.setCursor = function (cursor, allowOverScroll) {
      cursor = (0, _utils.precision)(cursor, _this.props.precision);
      var used = cursor;
      if (!_this.props.loop) {
  ...
  _createClass(TouchCarousel, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['component', 'cardSize', 'cardCount', 'cardPadCount', 'renderCard', 'stiffness', 'damping', 'precision', 'loop', 'moveScale', 'autoplay', 'vertical', 'clickTolerance']);
      ...
      return _react2.default.createElement(
        _reactMotion.Motion,
        {
          ...
          style: { cursor: dragging || moding ? cursor : (0, _reactMotion.spring)(cursor, springConfig) }
        },
        function (_ref) {
