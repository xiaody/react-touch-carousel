  ...
  _createClass(TouchCarousel, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['component', 'cardSize', 'cardCount', 'cardPadCount', 'renderCard', 'stiffness', 'damping', 'precision', 'maxOverflow', 'loop', 'moveScale', 'autoplay', 'vertical', 'clickTolerance']);
