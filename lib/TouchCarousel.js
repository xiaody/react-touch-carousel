  ...
  _createClass(TouchCarousel, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['component', 'cardSize', 'cardCount', 'cardPadCount', 'renderCard', 'loop', 'moveScale', 'damping', 'autoplay', 'vertical', 'precision', 'clickTolerance']);
