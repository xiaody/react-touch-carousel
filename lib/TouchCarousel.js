  ...
  _createClass(TouchCarousel, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          maxOverflow = _props2.maxOverflow,
          defaultCursor = _props2.defaultCursor,
          loop = _props2.loop,
          moveScale = _props2.moveScale,
          autoplay = _props2.autoplay,
          vertical = _props2.vertical,
          clickTolerance = _props2.clickTolerance,
          rest = _objectWithoutProperties(_props2, ['component', 'cardSize', 'cardCount', 'cardPadCount', 'renderCard', 'stiffness', 'damping', 'precision', 'maxOverflow', 'defaultCursor', 'loop', 'moveScale', 'autoplay', 'vertical', 'clickTolerance']);
